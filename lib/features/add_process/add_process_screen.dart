...
import 'package:miprocesoapp/features/add_process/add_process_provider.dart';
import 'package:miprocesoapp/utils/values/colors.dart';
import 'package:miprocesoapp/utils/values/texts.dart';
import 'package:miprocesoapp/features/add_process/add_process_text_formfield.dart';
import 'package:miprocesoapp/features/add_process/dropdown_button.dart';
...
class AddProcessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (context) => AddProcessProvider()),
      ],
      child: Scaffold(
...
class _AddProcessFormat extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    bool isVisible = Provider.of<AddProcessProvider>(context).swich;
    return Column(
      children: [
...
class _Swich extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LiteRollingSwitch(
      ...
      onSwipe: (){}, 
      onChanged: (_){
        Provider.of<AddProcessProvider>(context, listen: false).swich = !Provider.of<AddProcessProvider>(context, listen: false).swich;
      }
    );
  }
}
